<template>
  <div class="text-gray-800 subpixel-antialiased">
    <header>
      <nav
      ...
      >
        ...
        <div class="flex items-center justify-between">
          <a
            href="https://github.com/avosalmon/"
            target="_blank"
            rel="noopener"
            class="mx-2 hover:text-blue-400 md:mx-4"
          >
            <svg
          ...
          <a
            href="https://twitter.com/avosalmon/"
            target="_blank"
            rel="noopener"
            class="mx-2 hover:text-blue-400 md:mx-4"
          >
          ...
          <a
            href="https://www.linkedin.com/in/ryuta-hamasaki/"
            target="_blank"
            rel="noopener"
            class="mx-2 hover:text-blue-400 md:mx-4"
          >
          ...
          <a
            href="https://www.instagram.com/avosalmon/"
            target="_blank"
            rel="noopener"
            class="mx-2 hover:text-blue-400 md:mx-4"
          >
    ...
    <div class="px-4 pb-20 mx-auto w-full md:w-2/3 lg:w-3/5 xl:w-1/2">
      <div class="text-center mb-4">
        <img
          src="~/assets/image/avatar.jpg"
          alt="avatar"
          class="inline rounded-full h-32"
        />
      </div>
      <h2 class="text-4xl font-semibold text-center mb-6">About Me</h2>
      <p class="text-xl leading-relaxed">
        I am a software engineer from Japan and currently based in Singapore.
        Over the past 5 years, I've been creating e-commerce and FinTech web
        applications using Laravel, Angular, and Vue.js. Making clean,
    ...
    <footer
      class="flex flex-col items-center justify-between text-gray-500 px-4 py-4 border-t border-gray-300 md:flex-row md:px-32"
    >
